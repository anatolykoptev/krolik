...
from krolik.agent.tools.filesystem import ReadFileTool, WriteFileTool, EditFileTool, ListDirTool
from krolik.agent.tools.shell import ExecTool
from krolik.agent.tools.web import WebSearchTool, WebFetchTool
from krolik.agent.tools.message import MessageTool
from krolik.agent.tools.spawn import SpawnTool
from krolik.agent.subagent import SubagentManager
from krolik.session.manager import SessionManager
...
class AgentLoop:
    ...
    def __init__(
        ...
        from krolik.config.schema import ExecToolConfig
        self.bus = bus
